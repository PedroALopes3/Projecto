...
char *cria_string(char Coluna_jogada, char orientação_jogada, int Linha_jogada,
                  int pontuação_jogada, char *jogada_conteudo) {
  int tamanho_linha = 1;
  if (Linha_jogada >= 10) {
    tamanho_linha = 2;
  }
...
// Criar array das jogadas possiveis
char **Criar_array_casas(int *Nºcasas_total) {
  int tamanho_dinamico = Tamanho_realocação;
...
char **Insere_casa_possivel_array(char **casas_possiveis, int *Nºcasas_total,
                                  int coluna, int linha, char orientação) {
  int i;
  char casa[3];
  casa[0] = (char)coluna;
  casa[1] = (char)linha;
...
void Marcar_casas(int Nºjogada, char *Coluna_jogada, char *orientação_jogada,
                  ...
                  int tamanho_tabuleiro, int pontuação_jogada,
                  int colunas_total, int linhas_total,
                  char dados[linhas_total][colunas_total][7], int modo_de_jogo,
                  char **casas_possiveis, int *Nºcasas_total) {
  ...
  if (Nºjogada == 1) {
    ...
    casas_possiveis = Insere_casa_possivel_array(
        casas_possiveis, Nºcasas_total, coluna1, linha1, *orientação_jogada);
  } else {
    for (int linha = 0; linha < tamanho_tabuleiro; linha++) {
      for (int coluna = 0; coluna < tamanho_tabuleiro; coluna++) {
        ...
        if ((c1 >= 65 && c1 <= 90) || (c1 >= 97 && c1 <= 122)) {
          ...
          casas_possiveis =
              Insere_casa_possivel_array(casas_possiveis, Nºcasas_total,
                                         coluna1, linha1, *orientação_jogada);
        }
      }
    }
  }
  ...
  for (int i = 0; i < *Nºcasas_total; i++) {
    printf("\n%s\n", casas_possiveis[i]);
  }
}

// Analise das casas
void analise_casas(char **casas_possiveis, int Nºcasas_total, int NºColunas_DIC,
                   char **Coluna_DIC, int *Nºtotal_jogadas_possiveis,
                   char **Jogadas_Possiveis, int Nºjogada,
                   int tamanho_tabuleiro, char *jogada_conteudo,
                   int *Linha_jogada, char *orientação_jogada,
                   char *Coluna_jogada, int colunas_total, int linhas_total,
                   char dados[linhas_total][colunas_total][7], char erros[6],
                   int modo_de_jogo, int *Nºjogada_array) {
  char casa[4];
        ...
        for (int b = 0; b < comprimento_da_palavra; b++) {
          *Coluna_jogada = *Coluna_jogada - b;
          ...
          if (validação_possivel_da_jogada(
            ...
            contabilização_de_pontos(Nºjogada, tamanho_tabuleiro,
                                     jogada_conteudo, *Linha_jogada,
                                     *orientação_jogada, *Coluna_jogada,
                                     colunas_total, linhas_total, dados);
            pontuação_jogada_possivel(
                ...
                *orientação_jogada, *Coluna_jogada, colunas_total, linhas_total,
                dados, &pontuação_jogada, modo_de_jogo);
            if (pontuação_jogada >= 0.5 * pontuação_jogada_Max) {
              char *jogada_possivel =
                  cria_string(*Coluna_jogada, *orientação_jogada, *Linha_jogada,
                              pontuação_jogada, jogada_conteudo);
              Jogadas_Possiveis = Insere_jogada_possivel_array(
                  Jogadas_Possiveis, Nºtotal_jogadas_possiveis, jogada_possivel,
                  Nºjogada, Nºjogada_array);
            }
            ...
            remove_posivel_jogada_tabuleiro(Nºjogada, tamanho_tabuleiro,
                                            jogada_conteudo, *Linha_jogada,
                                            *orientação_jogada, *Coluna_jogada,
                                            colunas_total, linhas_total, dados);
          }
...
int main(int argc, char *argv[]) {
  ...
  if (modo_de_jogo == 2) {
    ...
    int Nºcasas_total = 0;
    char **casas_possiveis = Criar_array_casas(&Nºcasas_total);
    char **Jogadas_Possiveis = Criar_array_jogadas(&Nºtotal_jogadas_possiveis);
    while (gameover == 0) {
      int pontuação_jogada = 0;
      char Coluna_jogada = '0', orientação_jogada = 'h';
      int Linha_jogada = 0;
      char *jogada_conteudo;
      Marcar_casas(Nºjogada, &Coluna_jogada, &orientação_jogada, &Linha_jogada,
                   jogada_conteudo, tamanho_tabuleiro, pontuação_jogada,
                   colunas_total, linhas_total, dados, modo_de_jogo,
                   casas_possiveis, &Nºcasas_total);
      for (int i = 0; i < Nºcasas_total; i++) {
        printf("\n%s\n", casas_possiveis[i]);
      }
char casa[4];
...
memcpy(jogada_conteudo, jogada_conteudo_Max, strlen(jogada_conteudo_Max));
      ...
      /*analise_casas(casas_possiveis, Nºcasas_total, NºColunas_DIC, Coluna_DIC,
                    &Nºtotal_jogadas_possiveis, Jogadas_Possiveis, Nºjogada,
                    tamanho_tabuleiro, jogada_conteudo, &Linha_jogada,
                    &orientação_jogada, &Coluna_jogada, colunas_total,
                    linhas_total, dados, erros, modo_de_jogo, &Nºjogada_array);*/
      Insere_jogada_tabuleiro(Nºjogada, tamanho_tabuleiro, jogada_conteudo,
                              Linha_jogada, orientação_jogada, Coluna_jogada,
                              colunas_total, linhas_total, dados);
      printf("\n%dºJogada:\n", Nºjogada);
  ...
  if (modo_de_jogo == 3) {
    ...
    for (int a = 0; a < NºColunas_DIC; a++) {
      jogada_conteudo = (char *)malloc((16) * sizeof(char));
      strcpy(jogada_conteudo, Coluna_DIC[a]);
      printf("%s\n", jogada_conteudo);
    }
  }
}
