...
//
//
//  Created by Pedro Lopes oN_15/04/2022.
//
...
/*
  ...
  */
   if (tamanho_tabuleiro % 2 != 0 && tamanho_tabuleiro <= 15 &&
        tamanho_tabuleiro >= 7) {
      printf("error: tamanho tabuleiro ");
    }
  ...
  if (modo_de_jogo == 2) {
    ...
    // leitura do dicionario
    int N_Colunas_DIC = 0;
    char *File_dicionario = "/Users/pedro/Desktop/Curso/1  "
                            "ano/2 Semestre/Programação/Laboratorio/Projecto/"
